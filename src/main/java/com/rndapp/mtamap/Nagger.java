                            ...
                            if (activity != null && !activity.isFinishing()){
                                ...
                                builder.setNeutralButton("Yes, I'd be\ndelighted!", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.rndapp.mtamap")));
                                    }
                                });
                            ...
                            if (activity != null && !activity.isFinishing()){
                                ...
                                builder.setNeutralButton("Yes, I'd be\ndelighted!", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        setCanNagApp(false);
                                        dialogInterface.cancel();
                                        activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.rndapp.mtamap.paid")));
                                    }
                                });
